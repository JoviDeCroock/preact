...
describe.only('useContext', () => {
	...
	it('should update when context changes and Provider is being seperated by non updating component', done => {
		const spy = sinon.spy();
		const Ctx = createContext(0);

		class NeverUpdate extends Component {
